  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-zinc-700 bg-zinc-900 px-2.5 py-1.5 text-xs shadow-xl',
          className
        )}
      >
        ...
        {payload.map((item: LegendPayloadItem) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-zinc-400">{itemConfig?.label}</span>
            </div>
          )
        })}
      </div>
